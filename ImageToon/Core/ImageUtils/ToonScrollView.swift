...
class ToonScrollView: UIScrollView {
    ...
    private var gridView: ToonGridView!
    ...
    override init(frame: CGRect) {
        ...
        gridView = ToonGridView(frame: bounds)
...
extension ToonScrollView: UIScrollViewDelegate {
...
extension ToonScrollView: UIGestureRecognizerDelegate {
